    ...
    return (
      <div className="bg-white rounded-xl border border-[var(--color-border)] overflow-hidden">
        <div className="px-5 sm:px-6 py-4 border-b border-[var(--color-border)] bg-[var(--color-background)]/80">
          <h2 className="text-lg sm:text-xl font-bold text-[var(--color-primary)]">Patient Volume</h2>
          <p className="text-xs sm:text-sm text-[var(--color-text-muted)]">Appointments and new patient trends</p>
        </div>
        <div className="flex items-center justify-center h-[320px] px-6 text-center text-sm text-[var(--color-text-muted)]">
          No patient volume data available for this period.
        </div>
      </div>
    )
  }
